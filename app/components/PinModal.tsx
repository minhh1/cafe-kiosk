...
export default function PinModal({ onVerify, onClose, title }: any) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-[300] flex items-center justify-center p-4 backdrop-blur-md">
      <div className="bg-white p-8 rounded-3xl w-full max-w-xs shadow-2xl text-center">
        ...
        <p className="text-[10px] text-slate-400 uppercase font-bold mb-6">{title || "Authorization Required"}</p>
